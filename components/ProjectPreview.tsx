...
const ProjectPreview: React.FC<Props> = ({
  ...
  return (
    <motion.div
      className={`h-[30rem] cursor-pointer rounded-3xl overflow-hidden ${
        dark ? "dark" : ""
      }`}
    ...
    >
      ...
      >
        <div className="flex justify-between">
          ...
          {/* <div className="h-12 w-12 bg-white rounded-full flex justify-center items-center cursor-pointer"></div> */}
        </div>
      </div>
    </motion.div>
  )
